            ...
            children: [
              ...
              selectedsubject.isNotEmpty
                  ? FutureBuilder(
                                ...
                                child: DropdownButtonFormField(
                                    ...
                                    items: dates.data!.docs.map<DropdownMenuItem<String>>((value) {
                                      return DropdownMenuItem<String>(
                                        ...
                                        child: Text(
                                            DateFormat('dd  MMM  yyyy hh:mm').format(DateFormat('dd-MM-yyyy-hh-mm').parse(value.id)),
                      ...
                      future: state.subject[selectedsubject][0].collection(selectedsubject).orderBy('time', descending: true).get(),
                    )
                  : Container(),
                                  ...
                                  return Padding(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        ...
                                        color: attendance[key] ? Colors.green[200] : Colors.red[200],
                                      ),
